...
import img from '../../imagenes/cat.jpg';
      ...
      <div className={styles.contenedorPrincipalDark}>
        <div className={styles.contenedorTI}>
          <div className={styles.contenedorHeader}>
            ...
            <span className={styles.presentacion}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni praesentium similique nihil consectetur eos, cum animi optio rem? Iusto, reprehenderit! Mollitia sequi optio officiis itaque nemo, pariatur atque iste impedit?</span>
          </div>
